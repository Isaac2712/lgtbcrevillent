function btnCambiarContraseña()
{
	...
	{
		$('#div_contraseña').html("<aside style='font-size:12px;' class='mt-1 mb-0 alert alert-danger' role='alert'> La contraseña no es valida. Debe contener al menos una letra mayuscula, un numero, un simbolo y 8 caracteres. Ejemplo: Lgtbcrevi2. </aside>").show().delay(9000).fadeOut("fast");
		validar = true;
	}
	else
	{
